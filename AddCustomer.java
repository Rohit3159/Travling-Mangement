...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(String username ){
        ...
        choosed = new JComboBox ( new String[] {"Select", "Passport", "Adhaar card", "Pan Card "});
        choosed.setBounds(220,90,150,25);
        choosed.setBackground(Color.WHITE);
        choosed.setForeground(Color.BLUE);
        add( choosed);
...
//        
     ...
     public void actionPerformed(ActionEvent ae){
         if(ae.getSource()== add){
             ...
             String id = (String)choosed.getSelectedItem();
