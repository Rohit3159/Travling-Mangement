...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel[] label1 = new JLabel[]{ l1,l2,l3,l4,l5,l6,l7,l8,l9,l10};
    JLabel caption;
    
      public void run(){
          
          String[] text=new String[]{"JW Marriott Hotel","Madrin Oriental Hotel","Four Season Hotel","Raddisson Blue Hotel", "Classio Hotel","The Bay Clib Hotel","Breeze Blow Hotel","The Taj Hotel Mumnbai","Happy MorningMottel","River View Hotal"};
    ...
    for (int i = 0;i<=9;i++){
      ...
      label1[i]=new JLabel(kimage[i]);
      label1[i].setBounds(0,0,800,600);
      add(label1[i]);
