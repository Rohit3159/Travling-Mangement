...
import javax.swing.*;
import java.awt.*;
public class Destinantion extends JFrame implements Runnable{
    Thread t1;
    ...
    JLabel caption;
      ...
      public void run(){
          ...
          String[] text=new String[]{"JAMMU KASHMIR","MANALI","BANARAS UTTAR PARDESH","DARJEELING", "RADHA KRISHNA TEMPLE","INDIA GATE, DELHI","GANGTOK","SRI LANKA"};
