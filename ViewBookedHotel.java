...
public class ViewBookedHotel extends JFrame implements ActionListener {
     ...
     ViewBookedHotel(String username){
      ...
      JLabel lblpacakge = new JLabel("Hotel Name");
      ...
      lblphnum.setBounds(30,370,150,25);
      add(lblphnum);
      
      
      JLabel labelphnumber = new JLabel();
     labelphnumber.setBounds(220,370,150,25);
      add(labelphnumber);
      
      JLabel lblprc= new JLabel("Total Cost");
      lblprc.setBounds(30,410,150,25);
      add(lblprc);
